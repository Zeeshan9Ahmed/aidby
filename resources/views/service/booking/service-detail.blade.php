            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12">
                        ...
                        <div class="textBox">
                            <div class="genBar xy-between">
                                <div class="leftCol d-flex align-items-center">
                                    <p class="title me-3">{{$service->sub_category->title}}</p>
                                </div>

                                <p class="price"><span>$</span>{{$service->per_hour_rate}}</p>
                            </div>
                            <p class="desc">
                    ...
                    <div class="form-group">
                        <input type="text" class="genInput mb-2" value="{{\Carbon\Carbon::parse($service->date)->format('m/d/Y') }}" disabled>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="genCard1 addressCard1">
                        <div class="fig xy-between">
                            ...
                            <span class="amount">${{$service->per_hour_rate}}</span>
                        </div>
